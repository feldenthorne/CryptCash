    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("CryptCash") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/cryptcash"));
    setWindowIcon(QIcon(":icons/cryptcash"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("cryptcash");
    setStyleSheet("#cryptcash { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CryptCash address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/overview"), tr("&Masternodes"), this);
    ...
    aboutAction = new QAction(tr("&About CryptCash"), this);
    aboutAction->setToolTip(tr("Show information about CryptCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for CryptCash"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/cryptcash"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/cryptcash_testnet"));
            setWindowIcon(QIcon(":icons/cryptcash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/cryptcash_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CryptCash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CryptCash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptCash network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CryptCash address or malformed URI parameters."));
    }
