...
win32 {
        ...
        SECP256K1_LIB_PATH=C:/deps/libsecp256k1/usr/local/lib
        SECP256K1_INCLUDE_PATH=C:/deps/libsecp256k1/usr/local/include
}
...
macx:ICON = src/qt/res/icons/cryptcash.icns
macx:TARGET = "CryptCash-Qt"
